# test_nexuschain.py
"""Tests for NexusChain."""

import pytest
from nexuschain import NexusChainCore, NexusChain


class TestCore:
    def setup_method(self):
        self.core = NexusChainCore(threshold=0.75)
